...
<%--       <jsp:useBean id="member" scope="session" class="com.cia103g5.mem.model.Member_info" /> --%>
      ...
      <div class="container">
          ...
          <div class="mem_center">
            <div class="mem_photo">
              <img src="data:image/*;base64,<%= request.getAttribute("photo") %>" alt="會員大頭照" style="width:100px; height:100px;">
              <br>
              <button>更換照片</button>
            </div>
             <div class="mem_info">
          <table>
              <tr>
                  <td>會員編號：</td>
                  <td><%= request.getAttribute("mem_id") %></td>
              </tr>
              <tr>
                  <td>姓名：</td>
              ...
              <tr>
                  <td>驗證email狀態：</td>
                  <td><%= request.getAttribute("email_state") %></td>
              </tr>
              <tr>
                  <td>大頭照：</td>
                  <td>
                      <img src="<%= request.getAttribute("photo") %>" alt="會員大頭照" style="width:100px; height:100px;">
                  </td>
              </tr>
              <tr>
                  <td>會員註冊時間：</td>
                  <td><%= request.getAttribute("registered_at") %></td>
              </tr>
              <tr>
                  <td>總積分：</td>
                  <td><%= request.getAttribute("points") %></td>
              </tr>
          </table>
